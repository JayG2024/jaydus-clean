...
const LoginPage: React.FC = () => {
  ...
  const { signIn, user, demoSignIn } = useAuth();
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl overflow-hidden">
        <div className="p-6 sm:p-8">
          <div className="text-center mb-6">
            ...
            <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">Sign in to continue to your dashboard.</p>
          </div>
          ...
          <div className="mb-6">
            <button
              ...
              disabled={isLoading}
              className="w-full flex justify-center py-3 px-4 border-2 border-dashed border-primary-300 dark:border-primary-700 rounded-md text-sm font-medium text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20 hover:bg-primary-100 dark:hover:bg-primary-900/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:focus:ring-offset-gray-800 disabled:opacity-50 transition-colors"
            >
              {isLoading ? (
                <>
                ...
                '🚀 Quick Demo Sign-In (demo@jaydus.ai)'
              )}
            </button>
            <p className="mt-2 text-xs text-center text-gray-500 dark:text-gray-400">
              Skip the form and try the app instantly!
            </p>
          </div>
