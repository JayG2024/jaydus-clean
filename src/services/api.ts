...
const NETLIFY_FUNCTIONS_URL = process.env.NODE_ENV === 'development' 
  ? '/.netlify/functions'
  : 'https://jaydus-platform.netlify.app/.netlify/functions';
...
export const STRIPE_API = {
  createCheckoutSession: `${NETLIFY_FUNCTIONS_URL}/create-checkout`,
  createCustomerPortal: `${NETLIFY_FUNCTIONS_URL}/create-portal`,
};
